...
```{r caching, cache = TRUE, results = 'hide', echo = FALSE}
timings[]
```
...
```{r absolute_results, results = 'hide'}
timings[ , {
  by = 'n_rows'
...
```{r relative_results, results = 'hide'}
timings[ , {
  by = 'n_rows'
  xlab_map = c(n_rows = '# Rows', precision = 'Geohash Precision')
  log_map = c(n_rows = 'xy', precision = 'y')
